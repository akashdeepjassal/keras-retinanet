...
class PascalVocGenerator(Generator):
    ...
    def image_aspect_ratio(self, image_index):
        ...
        path  = os.path.join(self.data_dir,set_name, 'images', self.image_names[image_index] + self.image_extension)
    ...
    def image_path(self, image_index):
        ...
        """
        set_name=self.set_name
        return os.path.join(self.data_dir,set_name, 'images', self.image_names[image_index] + self.image_extension)
    ...
    def load_annotations(self, image_index):
        ...
        set_name=self.set_name
        try:
            tree = ET.parse(os.path.join(self.data_dir,set_name, 'annotations', filename))
            # print(tree.getroot())
...
class VisDroneGenerator(Generator):
    """ Generate data for a Pascal VOC dataset.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(VisDroneGenerator, self).__init__(**kwargs)
